...
abstract class Repository implements RepositoryInterface {
    ...
    public function findBy( array $criteria ) {
        ...
        foreach ( $criteria as $criterian ) {
            $this->queryBuilder->where( ...$criterian );
        }
    ...
    public function findAll( int $id ): array{
        return $result = $this->queryBuilder->table( static::$table )->select()->runQuery()->fetchInto( static::$className );
    ...
    public function update( Entity $entity, array $conditions = [] ): object {
        ...
        return $this->queryBuilder->find( $entity->getId() );
    }
